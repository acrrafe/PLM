...
class HDFailedPage extends StatefulWidget {
  final String email;
  final String name;
  final int studNum;

  HDFailedPage({required this.email, required this.name, required this.studNum});

  @override
  _HDFailedPageState createState() => _HDFailedPageState();
}

class _HDFailedPageState extends State<HDFailedPage> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 30),
            Text(
              "Please wait for clearance from our officials of the University Health Services",
